    ...
    IDividendPayingTokenOptional
{
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            withdrawnDividends[user] = withdrawnDividends[user] + (
...
contract PFWToken is ERC20, Ownable {
    ...
    address public _dividendToken = 0xEa237441c92CAe6FC17Caaf9a7acB3f953be4bd1;
    ...
    constructor() ERC20("Plume Feather Wings", "PFW") {
        ...
        teamWallet = 0xC92bb8E5B15185f7a49D90609898a20CE7010DB3;
        treasurywallet = 0xb50b87Cca4FD3cC57Bf253507aBF09cEDE3072a1;
        marketingWallet = 0x4097c93769d76eb70A37982FD23aB0F0eeD820D5;
    ...
    function _transfer(
        ...
        if (tradingIsEnabled && automatedMarketMakerPairs[to]) {
            ...
            if (!swapping && canSwap) {
                ...
                uint256 bnbSwap = buytreasuryFee + (buyTeamFee) + (
                    buyMarketingFee
                );
        ...
        )
    {
        ...
        if (index >= 0) {
            if (uint256(index) > lastProcessedIndex) {
                iterationsUntilProcessed = index - (
